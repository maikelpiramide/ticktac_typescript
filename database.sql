...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tabla que almacena el superusuario que sería el primer usuario de la empresa (gestiona usuarios trabajadores y clientes)';

-- Volcando datos para la tabla ticktac.admin: ~1 rows (aproximadamente)
DELETE FROM `admin`;
...
-- Volcando datos para la tabla ticktac.plan: ~0 rows (aproximadamente)
DELETE FROM `plan`;
...
-- Volcando datos para la tabla ticktac.tipo_pago: ~0 rows (aproximadamente)
